...
import {addHostID} from '../database/hosts.js'
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, async function (error, response, body) {
      if (!error && response.statusCode === 200) {
        await setToken("auth_token", body.access_token, body.expires_in, body.refresh_token);
        //setToken("refresh_token", body.refresh_token, body.expires_in);
        
        //get user id from spotify and enter into db
        await addHostID();
